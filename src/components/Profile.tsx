    ...
    <div className="lg:w-4/5 mx-auto">
      ...
      <div className="flex flex-col sm:flex-row mt-10">
        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          <div className="flex flex-col items-center text-center justify-center">
            ...
            <p className="text-base">
              高校卒業後、服飾の専門校に通ったが、その後IT職に興味をもち、ITの訓練校を受講。
              現在は独学でWebデザインやプログラミング、機械学習などの分野を学習中</p>
          </div>
        </div>
        <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
          ...
          様々な形でのデザインや表現方法に触れる機会がありました。<br/>
          ものづくりに興味を惹かれ高校卒業後は服飾の専門校に通いながらカフェでアルバイトをしていましたが、将来やっていきたいことを考えたときに場所や時間にとらわれず自身のスキルとして成長していける環境で働きたいと思い、現在はデザインやプログラミング、AIの分野を学習中です。
          </p>
