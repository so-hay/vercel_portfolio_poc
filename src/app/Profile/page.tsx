      ...
      <div className="flex flex-col sm:flex-row mt-10">
        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          <div className="flex flex-col items-center text-center justify-center">
            ...
            <p className="text-base">高校卒業後、服飾の専門校に通ったが、IT職に興味をもち、専門卒業後にITの訓練校を受講。現在は独学でWebデザインとプログラミングを学習中</p>
          </div>
        </div>
        <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
          <p className="leading-relaxed text-lg mb-4">【経歴】 <br/>
          高校時代にAdobe illustrator、Photoshopを使った投影デザインやポスター、校内新聞の作成、3Dモデルとカッティングプロッターを使った舞台看板制作など、様々な形でのデザインや表現方法の仕方に触れて興味を持ちました。
          <br/>
          高校卒業後は服飾の専門校に通いながらカフェでアルバイトをしていましたが、将来やっていきたいことを考えたときにやはり自身のスキルとして成長していける環境で働きたいと思い、短期のIT訓練校に通いながらWebシステムやデザインを学び始めました。
          </p>
